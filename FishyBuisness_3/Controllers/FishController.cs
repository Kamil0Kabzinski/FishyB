...
namespace FishyBuisness_3.Controllers
{
    public class FishController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FishId,FishName,FishDescription,Spieces,Habitat,Lenght,Weight,Price")] Fish fish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FishId,FishName,FishDescription,Spieces,Habitat,Lenght,Weight,Price")] Fish fish)
        {
            if (id != fish.FishId)
            {
                return NotFound();
